...
res <- data.frame(type = c(rep("revmr", reps), rep("n_cc", reps), rep("actual",reps)), b=c(rev_mr_all$b, casecontrol$bhat, rep(rev_mr_result$beta, reps)), run=c(1:reps, 1:reps, 1:reps), se=c(rev_mr_all$se, casecontrol$se, rep(rev_mr_result$se, reps)))
